...
/**
 * 	\defgroup   quentin     Module Quentin
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/quentin/core/modules directory.
 *  \file       htdocs/quentin/core/modules/modQuentin.class.php
 *  \ingroup    quentin
 *  \brief      Description and activation file for module Quentin
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Quentin
 */
class modQuentin extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 105001; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'quentin';
		...
		$this->picto='quentin@quentin';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /quentin/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /quentin/core/modules/barcode)
		// for specific css file (eg: /quentin/css/quentin.css.php)
		...
		//							'css' => array('/quentin/css/quentin.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/quentin/js/quentin.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		$this->langfiles = array("quentin@quentin");
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@quentin:$user->rights->quentin->read:/quentin/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:mylangfile@quentin:$user->rights->othermodule->read:/quentin/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        $this->dictionaries=array(
            ...
            'tabcond'=>array($conf->quentin->enabled,$conf->quentin->enabled,$conf->quentin->enabled)												// Condition to show each dictionary
        );
        */
	...
	function init($options='')
	{
		...
		dol_include_once('/quentin/config.php');
		dol_include_once('/quentin/script/create-maj-base.php');

		$result=$this->_load_tables('/quentin/sql/');
