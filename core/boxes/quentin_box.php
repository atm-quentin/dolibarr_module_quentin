 ...
 */
class quentinbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "quentin@quentin";
    public $boxlabel;
    public $depends = array("quentin");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/quentin/class/quentin.class.php";
